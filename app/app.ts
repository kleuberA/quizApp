...
function verificaQuestaoCorreta(event: any, alternativaEscolhida: string){
    $('.list-group-item').each((index,el) => {
        if(!el.classList.contains('disabled')){
...
function modificaDisplayElemento(valorArgumento: string, segundoArgumento: string, terceiroArgumento?: string){
...
function proximaQuestão(cont: number){
